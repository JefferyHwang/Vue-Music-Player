            ...
            <el-row class="wrapper">
                <el-col :span="4">
                    <router-link to="/" class="logo">
                        ...
                        <div  style="color:white;font-size:40px;" class="logo">音乐</div>
                    </router-link>
                </el-col>
                <el-col :span="12">
                    <ul class="nav">
                ...
                <el-col :span="6">
                    <span class="search">
                        ...
                        <i class="iconfont icon-search" style="color:#fff;" slot="suffix" @click="search"></i>
                    </span>
                </el-col>
                        ...
                        <el-dropdown placement="bottom" @command="userMenuHandler">
                            <el-image :src="userInfo.avatarUrl" class="avatar">
                                <div slot="placeholder" class="image-slot">
                                    <i class="iconfont icon-placeholder" style="color:#fff;"></i>
                                </div>
                            </el-image>
